...
extension UIColor {
    ...
    static let customBlue: UIColor = UIColor(customRed: 120, customGreen: 175, customBlue: 255)
    static let customDarkBlue: UIColor = UIColor(customRed: 38, customGreen: 28, customBlue: 44)
}
